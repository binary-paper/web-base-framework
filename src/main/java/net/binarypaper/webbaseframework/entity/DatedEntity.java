...
public abstract class DatedEntity extends ActivatableEntity implements Serializable {
    ...
    public static Date parseDate(String dateString, String errorCode) throws BusinessLogicException {
        try {
            ...
            throw new BusinessLogicException(errorCode, Status.BAD_REQUEST.getStatusCode());
        }
    }

    public static List filterByEffectiveDate(List inputList, Date effectiveDate) throws BusinessLogicException {
        List<DatedEntity> datedEntities = (List<DatedEntity>) inputList;
        ...
        List<DatedEntity> outputList = new ArrayList<>();
        for (DatedEntity datedEntity : datedEntities) {
            Date effectiveFrom = datedEntity.getEffectiveFrom();
            Date effectiveTo = datedEntity.getEffectiveTo();
