 ...
 */
package net.binarypaper.webbaseframework.entity.lookup;
...
// Lombok annotations
@Data
@EqualsAndHashCode(callSuper = true, exclude = {"children", "revision"})
@ToString(callSuper = true, exclude = {"children", "revision"})
public class LookupValue extends DatedEntity implements Serializable {
    ...
    @Pattern(regexp = "[a-z,A-Z,0-9,_]*", message = "{LookupValue.lookupListName.Pattern}")
    // Jackson annotations
    @JsonProperty(value = "lookup_list")
    @JsonView({
        View.List.class,
        View.All.class,
        View.Add.class,
